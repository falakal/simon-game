...
def instructions(self):
    ...
    title_instructions = Label(frame_instructions, text="Instructions for the game:",
                               font=("times new roman", 20, "bold"), bg="beige",
                               fg="dimgray").place(x=50, y=20)
    instructions1 = Label(frame_instructions,
                          text="-1-Simon will give the first signal. Repeat the signal by pressing the same color lens.",
                          font=("times new roman", 15, "bold"),
                          bg="beige",
    ...
    btn_instructions_back = Button(frame_instructions, text="Menu", font=("times new roman", 15, "bold"),
                                   bg="firebrick",
                                   fg="beige",
                                   width=10,
...
def admin(self):
    ...
    title_admin = Label(frame_admin, text="Hello Admin", font=("times new roman", 25, "bold"), bg="#2E2E2E",
                        fg="#FF3030").place(
        x=20, y=30)
    ...
    btn2 = Button(frame_admin, text="- Show Report on a specific user", font=("times new roman", 14, "bold"),
                  bg="#2E2E2E",
